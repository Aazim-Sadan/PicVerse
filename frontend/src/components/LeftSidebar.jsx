...
const LeftSidebar = () => {
    ...
    const logoutHandler = async () => {
        try {
            const res = await axios.get('https://picverse.onrender.com/api/v1/user/logout',
                {
    ...
    const clearNotification = ()=>{
        setTimeout(() => {
            dispatch(setLikeNotification('clear'))
        }, 2000);
    }
                                        ...
                                        <Popover  >
                                            <PopoverTrigger asChild>
                                                ...
                                                onClick={clearNotification}
                                                    size='icon'
                                                    className="rounded-full h-5 w-5 bg-red-600 hover:bg-red-600 absolute bottom-6 left-6">{likeNotification.length}</Button>
                                            </PopoverTrigger>
                                            <PopoverContent>
                                                <div >
                                                    {
