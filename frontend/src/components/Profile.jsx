...
const Profile = () => {
  ...
  return (
    <div className='flex max-w-5xl justify-center mx-auto sm:pl-10'>
      <div className='flex flex-col gap-8 sm:gap-20 p-8'>
        <div className='sm:grid sm:grid-cols-2'>
          <section className='flex items-center justify-center'>
            <Avatar className="max-sm:mb-8 h-32 w-32">
          ...
          <section>
            <div className='flex max-sm:items-center flex-col gap-5'>
                ...
                <span className='font-bold'>{userProfile?.username}</span>
                {
                  isLoggedInUser ? (
                    ...
                    isFollowing ? (
                      ...
                      <Button Button className="bg-[#0095F6] hover:bg-[#2478b1] h-8">Follow</Button>
                    )
                  )
                }
              </div>
              ...
              <div className='flex max-sm:items-center flex-col gap-1'>
                <span className='font-semibold max-sm:text-center'>{userProfile?.bio || 'bio here...'}</span>
                <Badge className="w-fit"><AtSign /> <span className='pl-1'>{userProfile?.username}</span></Badge>
                <span>Don't stop Learning...</span>
